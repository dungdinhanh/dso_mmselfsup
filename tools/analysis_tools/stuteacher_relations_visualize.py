...
from mmselfsup.models.utils import GetRelationsTeacherStudent
...
def main():
    ...
    load_checkpoint(t_model, "work_dirs/selfsup/simsiam/simsiam_resnet50_4xb64-coslr-200e_in30p/epoch_200.pth",
                    map_location='cpu')
    ...
    if not distributed:
        ...
        t_model = MMDataParallel(t_model, device_ids=[0])
    else:
    ...
    extractor = GetRelationsTeacherStudent()
    features = extractor.extract(model, t_model, data_loader, distributed=distributed)
