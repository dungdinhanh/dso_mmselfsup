...
#PBS -N analysis_simsiam
#PBS -j oe
#PBS -o log/analysis_simsiam.log
#PBS -q gold
...
configs/selfsup/simsiam_kd_test/simsiam_dimcollapse_checkall_resnet18_4xb64-coslr-200e_in1p1r.py 4 \
