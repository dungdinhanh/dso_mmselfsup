...
from mmselfsup.models.utils import ExtractEncoderDifferenceProcess, ExtractEncoderDifferenceProcessMTV
...
def main():
    ...
    extractor = ExtractEncoderDifferenceProcessMTV()
