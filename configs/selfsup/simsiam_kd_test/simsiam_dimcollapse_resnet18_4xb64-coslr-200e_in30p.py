_base_ = [
    '../_test_/models/resnet18_simsiam_dimcollapse.py',
    '../_test_/datasets/imagenet30p_mocov2_wori_b64_cluster.py',
...
# runtime settings
runner = dict(type='KDBasedRunnerSaveImages', max_epochs=200)
