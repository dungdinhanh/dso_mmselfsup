...
#PBS -N nogtSimpredTarget
#PBS -j oe
#PBS -o log/nogtsimpredtarget.log
#PBS -q gold
...
configs/selfsup/simdis_test/simdis_nogt_simpredtarget_resnet18_4xb64-coslr-200e_in30p.py 4 \
--teacher_path \
 ../../scratch/dso/openss/work_dirs/selfsup/simsiam/simsiam_resnet50_4xb64-coslr-200e_in30p/epoch_200.pth &>> log/nogtsimpredtarget.log"
echo ${cmd}
eval ${cmd}
