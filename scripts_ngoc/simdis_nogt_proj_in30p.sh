...
configs/selfsup/simdis_test/simdis_nogt_simproj_resnet18_4xb64-coslr-200e_in30p.py 4 \
--teacher_path ../../scratch/dso/openss/work_dirs/selfsup/simsiam/simsiam_resnet50_4xb64-coslr-200e_in30p/epoch_200.pth"
echo ${cmd}
eval ${cmd}

cmd="bash tools/dist_train_kd_cluster.sh ${USER} \
configs/selfsup/simdis_test/simdis_nogt_crossproj_resnet18_4xb64-coslr-200e_in30p.py 4 \
--teacher_path ../../scratch/dso/openss/work_dirs/selfsup/simsiam/simsiam_resnet50_4xb64-coslr-200e_in30p/epoch_200.pth"
echo ${cmd}
eval ${cmd}